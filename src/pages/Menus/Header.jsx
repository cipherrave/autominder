...
export default function Header() {
  ...
  return (
    <div className="sm:px-5 h-[50px] p-4 px-6 gap-2 items-center flex w-full border-b border-gray-200 bg-white dark:bg-gray-900 dark:text-white dark:border-gray-800 sticky top-0">
      <div className="flex w-full">
        <div className="flex items-center gap-1 flex-grow flex-shrink">
          <h1 className="font-bold text-1xl text-gray-900 dark:text-white">
            AutoMinder
          </h1>
          <button
            onClick={navDash}
