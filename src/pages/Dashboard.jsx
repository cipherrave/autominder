...
import HeaderVehicle from "./Menus/HeaderVehicle";
import SideDash from "./Menus/SideDash";

function Dashboard() {
  return (
    <div className="bg-gray-100 dark:bg-gray-900 dark:text-white text-gray-600 h-screen flex overflow-hidden text-sm ">
      <div className="bg-white dark:bg-gray-900 dark:border-gray-800 w-20 flex-shrink-0 border-r border-gray-200 flex-col flex">
        <SideDash></SideDash>
      </div>
      <div className="flex-grow overflow-hidden h-full flex flex-col">
        <div className="flex-grow flex overflow-x-hidden">
          ...
          <div className="flex-grow bg-white dark:bg-gray-900 overflow-y-auto">
            ...
            <div className="sm:p-7 p-4" id="servicelist">
